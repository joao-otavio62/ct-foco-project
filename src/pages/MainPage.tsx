...
const teamMembers = [
  {
    ...
    bio: "10+ anos de experiência em treinamento funcional de alta performance.",
  },
  {
    name: "Ana Paula Rocha",
    role: "Instrutora de Pilates",
    img: "https://randomuser.me/api/portraits/women/44.jpg",
    bio: "Especialista em Pilates clínico e reabilitação postural.",
  },
  {
    name: "Dr. Felipe Costa",
    role: "Fisioterapeuta",
    img: "https://randomuser.me/api/portraits/men/58.jpg",
    bio: "CREFITO ativo, especialização em fisioterapia esportiva.",
  },
  {
    name: "Juliana Lima",
    role: "Instrutora de Funcional",
    img: "https://randomuser.me/api/portraits/women/68.jpg",
    bio: "Personal trainer certificada e ex-atleta de crossfit.",
  },
  {
    name: "Rafael Torres",
    role: "Coordenador de Turmas",
    img: "https://randomuser.me/api/portraits/men/11.jpg",
    bio: "Responsável pela gestão de horários e experiência dos alunos.",
  },
];
...
export function MainPage() {
  ...
  const nextSlide = () => setCarouselIdx((prev) => (prev + 1) % teamMembers.length);
  const prevSlide = () => setCarouselIdx((prev) => (prev - 1 + teamMembers.length) % teamMembers.length);
  ...
  return (
    <div className="bg-black text-white font-sans overflow-x-hidden">
      ...
      <section className="relative w-full h-screen flex items-center justify-center overflow-hidden">
        <div
          className={`video-overlay absolute inset-0 z-10 bg-black ${videoExpanded ? "opacity-0 pointer-events-none" : "opacity-60"}`}
        />
      ...
      >
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div>
            <p
              className={`fade-left text-red-600 text-xs font-medium tracking-[0.3em] uppercase mb-4 ${isVisible("sobre") ? "visible" : ""}`}
            >
              Sobre o CT FOCO
            </p>
            <h2
              className={`fade-left stagger-1 font-display font-black text-5xl md:text-7xl leading-none mb-6 ${isVisible("sobre") ? "visible" : ""}`}
            >
              ONDE O<br />
              <span className="text-red-600">FOCO</span><br />
              TRANSFORMA
            </h2>
            <p
              className={`fade-left stagger-2 text-gray-400 leading-relaxed mb-8 max-w-md ${isVisible("sobre") ? "visible" : ""}`}
            >
          ...
          <div
            className={`fade-right ${isVisible("sobre") ? "visible" : ""} relative`}
          >
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-16">
            ...
            <h2 className={`fade-up stagger-1 font-display font-black text-5xl md:text-7xl ${isVisible("horarios") ? "visible" : ""}`}>
              HORÁRIOS<br />
              <span className="text-red-600">DISPONÍVEIS</span>
            </h2>
          </div>
                  ...
                  <div className="bg-neutral-950 border border-neutral-800 overflow-hidden group">
                    <div className="relative overflow-hidden aspect-[3/4]">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-6">
                        ...
                        <p className="text-red-500 text-sm tracking-wider uppercase mt-1">{member.role}</p>
                      </div>
                    </div>
                    <div className="p-6">
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className={`fade-left stagger-1 font-display font-black text-5xl md:text-7xl leading-none mb-6 ${isVisible("contato") ? "visible" : ""}`}>
              AGENDE<br />
              SUA <span className="text-red-600">AULA</span>
            </h2>
      ...
      <footer className="bg-neutral-950 border-t border-neutral-900 py-12 px-6 md:px-20">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8 items-start">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">⏰ Seg–Sáb: 06h00 – 22h00</p>
          </div>
        </div>
